...
# CLARITAS 4.2 optical-object model.
#
...
#
# Flocs are NOT treated as Mie spheres in CLARITAS 4.2.
...
print("Primary reflection fudge: disabled/removed from CLARITAS_42 transport")
