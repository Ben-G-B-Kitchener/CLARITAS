...
# Process-based ray tracer with collision-fraction pooled-mass floc PSD model, explicit mu_s step factor, floc phase-regime mixture, concentration-dependent floc properties, detector-geometry diagnostics, and scatter-count-dependent floc back-fraction.
...
FLOC_PHASE_FORWARD_FRACTION = 0.35
FLOC_PHASE_SIDE_FRACTION = 0.5
FLOC_PHASE_BACK_FRACTION = 0.15
...
FLOC_BACK_FRACTION_SCATTER_GAIN = 1.0
FLOC_BACK_FRACTION_SCATTER_COUNT = 10.0
FLOC_BACK_FRACTION_MAX = 0.80
FLOC_FORWARD_FRACTION_MIN = 0.05

FLOC_SIDE_SCATTER_MIN_DEG = 0.0
FLOC_SIDE_SCATTER_MAX_DEG = 180.0
...
FLOC_BACKSCATTER_STD_BASE_DEG = 30.0
            ...
            if (is_floc_event) {
                ...
                if (u_phase < forward_fraction_this) {
                    ...
                    new_angle =
                        ray_angle +
                        3.1415927f +
                        gaussian_jitter(&stateJITTER, backscatter_std_this);
                }
            }
            else {
