...
# Controls the angular width of the extracted diffraction lobe.
# 1.0 = physical width; >1 narrower; <1 broader.
MONOMER_DIFFRACTION_WIDTH_FACTOR = 1.0

mie_cache_version = "claritas_5p0_monomer_diffraction_internal_split_v2"
...
def floc_synthetic_structure_profile(bin_idx, wavelength_m, mu_values, theta_rad_values):
    """
    CLARITAS_50 floc aggregate phase function.
