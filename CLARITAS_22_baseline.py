...
# Process-based ray tracer with collision-fraction pooled-mass floc PSD model, explicit mu_s step factor, floc phase-regime mixture, and concentration-dependent floc properties.
