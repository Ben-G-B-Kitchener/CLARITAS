...
# CLARITAS 4.3 optical-object model.
#
...
for idx, (r, refr_index, is_floc) in enumerate(zip(
    ...
    if is_floc:
        ...
        # The multiplier is retained as a material/process parameter but now
        # acts on the physically derived k_eff rather than on raw density.
        k_eff = (
...
mie_cache_version = "claritas_4p3_mg_effective_complex_index_v1"
