# CLARITAS_100: Polarised vector radiative transfer Monte Carlo
...
if _CUPY_AVAILABLE:
    ...
    def trace_rays_gpu(angles_init_np, R, ray_off, beam_sigma, collimated,
        ...
        with h5py.File(hdf5_file, "w") as f:
            f.attrs["claritas_version"] = "100_gpu"
...
print("="*70)
print("CLARITAS_100: Polarised Vector Radiative Transfer Monte Carlo")
...
for wl_idx, wl in enumerate(wavelengths):
    ...
    if _CUPY_AVAILABLE:
        trace_rays_gpu(angles_init, R_REAL, RAY_OFFSET, PRODUCTION_BEAM_SIGMA_M,
...
plt.title("Detector Response — CLARITAS_100 Polarised MC")
...
if len(wavelengths)==1:
    ...
    plt.suptitle(f"Polarisation Diagnostics — CLARITAS_100 — {wl_nm} nm",fontsize=14,fontweight="bold")
    plt.tight_layout()
...
for wl_idx,wl in enumerate(wavelengths):
    ...
    if os.path.exists(hf):
        ...
        plt.title(f"Scatter Count Histogram — CLARITAS_100 — {wl_nm} nm")
