...
mie_cache_version = "claritas_5p6_kernel_floc_pooling_physical_guard_v1"
...
def trace_rays_gpu(angles_init_np, primary_roughness_std_rad, floc_roughness_std_rad,
    ...
    with h5py.File(hdf5_file, "w") as f:
        ...
        for start in tqdm(range(0, N, estimated_chunk), total=(N + estimated_chunk - 1)//estimated_chunk, desc="Tracing rays"):
            ...
            # Free GPU memory
            del angles_chunk, exit_dir_chunk_dev, exit_x_chunk_dev, exit_y_chunk_dev, rpl_chunk_dev, scatter_count_chunk_dev, floc_event_count_chunk_dev, last_event_was_floc_chunk_dev, extinction_count_chunk_dev, absorbed_chunk_dev
            cp._default_memory_pool.free_all_blocks()
