...
# Process-based ray tracer with collision-fraction pooled-mass floc PSD model, explicit mu_s step factor, floc phase-regime mixture, concentration-dependent floc properties, and detector-geometry diagnostics.
...
print(f"FLOC_BACKSCATTER_STD_DEG: {FLOC_BACKSCATTER_STD_DEG:.3f}")
            ...
            if (is_floc_event) {
                ...
                if (u_phase < FLOC_PHASE_FORWARD_FRACTION) {
                    ...
                    new_angle =
                        ray_angle +
                        3.1415927f +
                        gaussian_jitter(&stateJITTER, FLOC_BACKSCATTER_STD_RAD);
                }
            }
            else {
