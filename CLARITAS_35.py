...
if os.path.exists(mie_cache_file):
    ...
    print("Building angular tables: primary Mie + synthetic fractal floc structure diagnostics...")
...
plt.title("Angular scattering profiles - primary Mie + synthetic fractal floc structure")
