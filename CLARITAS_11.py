...
# Process-based ray tracer with fixed effective floc PSD and dual reflection controls.
...
#   - Those bins receive a fixed larger effective diameter.
...
FLOC_ENABLED = True
FLOC_PRIMARY_MAX_DIAMETER = 10.0e-6
FLOC_DIAMETER_MULTIPLIER = 10.0
...
PRIMARY_REFLECT_SIZE_THRESHOLD = 30.0e-6

FLOC_REFLECT_PROB = 0.0
FLOC_REFLECT_SIZE_THRESHOLD = 10.0e-6
...
print(f"FLOC_DIAMETER_MULTIPLIER: {FLOC_DIAMETER_MULTIPLIER:.3f}")
...
mie_cache_version = "per_particle_intensity_no_sin_theta_fixed_floc_psd_v1"
