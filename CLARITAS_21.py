...
# Process-based ray tracer with collision-fraction pooled-mass floc PSD model, explicit mu_s step factor, and floc phase-regime mixture.
...
FLOC_COLLISION_LENGTH_M = 50.0e-6
...
FLOC_PHASE_FORWARD_FRACTION = 0.50
FLOC_PHASE_SIDE_FRACTION = 0.25
FLOC_PHASE_BACK_FRACTION = 0.25
...
# They no longer control floc angular physics when the phase-regime mixture is active.
FLOC_REFLECT_PROB = FLOC_PHASE_BACK_FRACTION
