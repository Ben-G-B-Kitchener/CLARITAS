#!/usr/bin/env python3
"""Inference-oriented CLARITAS V23.2 forward model for PSD Inference V2.

This module is intentionally physics-identical to the V1 inference forward kernel.
It preserves the V23.2 particle physics but removes plotting, HDF5 and
